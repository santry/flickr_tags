...
class Flickr
  ...
  def initialize(api_key='11111111111222222222333333344444', email=nil, password=nil)
    @api_key = api_key
  ...
  class User
    ...
    def photos(per_page=7, page=1)
      @client.people_getPublicPhotos('user_id'=>@id, 'per_page' => per_page.to_s, 'page' => page.to_s)['photos']['photo'].collect { |photo| Photo.new(photo['id']) }
